...
Complete `AgentWorkSpace/handoffs/implementation-spec.md` first, then create the
authoritative `AgentWorkSpace/ImplementationSteps/slice-N.md` handoff set as
