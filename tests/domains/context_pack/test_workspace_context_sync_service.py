        ...
        with tempfile.TemporaryDirectory() as temp_root:
            ...
            result = service.apply_sync(
                ...
                deep_focus={
                    ...
                    "selected_focus_path": "src/orders",
            ...
            self.assertTrue(result["deep_focus_enabled"])
            self.assertEqual(result["selected_focus_path"], "src/orders")
            self.assertEqual(
