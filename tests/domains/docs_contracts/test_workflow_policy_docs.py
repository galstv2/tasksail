...
class WorkflowPolicyDocsTests(unittest.TestCase):
    ...
    _POSITIVE_ASSERTIONS: list[tuple[str, str]] = [
        ...
        ("onboarding", "AgentWorkSpace/handoffs/retrospective-input.md"),
        ("operating_model", "AgentWorkSpace/handoffs/retrospective-input.md"),
        ("platform_spec", "AgentWorkSpace/handoffs/retrospective-input.md"),
        ("qmd_task_filing_system", "AgentWorkSpace/handoffs/retrospective-input.md"),
        ("readme", "fail closed"),
        ("onboarding", "fail closed"),
