...
vi.mock('../archive/archivedTasks', () => ({ listArchivedTasksAction }));
...
import { readTaskContent } from './board';
...
// Mock a nested archive root containing the canonical archive, handoff summary,
// mixed slice artifacts, plus entries that must be skipped.
