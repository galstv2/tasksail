...
import { startTaskBoardWatcher } from '../tasks/board';
import { startTaskRecoveryController } from './recovery';
import { startRuntimeStreamWatcher } from '../runtime/runtimeStream';
import {
  getCurrentActiveContextPackTaskScope,
  refreshCurrentActiveContextPackTaskScope,
} from '../contextPack/taskVisibility';
import { cleanupWorkspaceOnQuit } from './cleanup';
import { TASKSAIL_DEV_GRACEFUL_RESTART_MESSAGE } from '../devRestartProtocol';
import { createWindow, focusMainWindow } from './windowManager';
import {
  cleanupStalePipelineState,
  schedulePipelineAutoStart,
} from './startupRecovery';
import { recoverPlannerParentBranchViewsOnStartup } from '../planner/parentBranchView';
...
import { restartTaskSailApp } from './restart';
import { DesktopActionRouter } from '../ipc/desktopActionRouter';
import { DesktopIpcContract } from '../ipc/contract';
import {
...
} from '../contextPack/watcher';
import { startTaskNotificationRuntime } from '../tasks/notifications';
