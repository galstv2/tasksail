...
// ---------------------------------------------------------------------------
// 1. normalizeGitignoreLanguage — canonical keys
// ---------------------------------------------------------------------------

describe('normalizeGitignoreLanguage — canonical values', () => {
  it('maps csharp directly', () => expect(normalizeGitignoreLanguage('csharp')).toBe('csharp'));
  it('maps typescript directly', () => expect(normalizeGitignoreLanguage('typescript')).toBe('typescript'));
  it('maps javascript directly', () => expect(normalizeGitignoreLanguage('javascript')).toBe('javascript'));
  it('maps python directly', () => expect(normalizeGitignoreLanguage('python')).toBe('python'));
  it('maps java directly', () => expect(normalizeGitignoreLanguage('java')).toBe('java'));
  it('maps go directly', () => expect(normalizeGitignoreLanguage('go')).toBe('go'));
  it('maps rust directly', () => expect(normalizeGitignoreLanguage('rust')).toBe('rust'));
  it('maps ruby directly', () => expect(normalizeGitignoreLanguage('ruby')).toBe('ruby'));
  it('maps sql directly', () => expect(normalizeGitignoreLanguage('sql')).toBe('sql'));
  it('maps hcl directly', () => expect(normalizeGitignoreLanguage('hcl')).toBe('hcl'));
  it('maps shell directly', () => expect(normalizeGitignoreLanguage('shell')).toBe('shell'));
  it('maps powershell directly', () => expect(normalizeGitignoreLanguage('powershell')).toBe('powershell'));
});
...
describe('normalizeGitignoreLanguage — aliases', () => {
  it('c# -> csharp', () => expect(normalizeGitignoreLanguage('c#')).toBe('csharp'));
  it('dotnet -> csharp', () => expect(normalizeGitignoreLanguage('dotnet')).toBe('csharp'));
  it('.net -> csharp', () => expect(normalizeGitignoreLanguage('.net')).toBe('csharp'));
  it('ts -> typescript', () => expect(normalizeGitignoreLanguage('ts')).toBe('typescript'));
  it('tsx -> typescript', () => expect(normalizeGitignoreLanguage('tsx')).toBe('typescript'));
  it('js -> javascript', () => expect(normalizeGitignoreLanguage('js')).toBe('javascript'));
  it('jsx -> javascript', () => expect(normalizeGitignoreLanguage('jsx')).toBe('javascript'));
  it('node -> javascript', () => expect(normalizeGitignoreLanguage('node')).toBe('javascript'));
  it('py -> python', () => expect(normalizeGitignoreLanguage('py')).toBe('python'));
  it('jvm -> java', () => expect(normalizeGitignoreLanguage('jvm')).toBe('java'));
  it('golang -> go', () => expect(normalizeGitignoreLanguage('golang')).toBe('go'));
  it('rs -> rust', () => expect(normalizeGitignoreLanguage('rs')).toBe('rust'));
  it('rb -> ruby', () => expect(normalizeGitignoreLanguage('rb')).toBe('ruby'));
  it('rails -> ruby', () => expect(normalizeGitignoreLanguage('rails')).toBe('ruby'));
  it('database -> sql', () => expect(normalizeGitignoreLanguage('database')).toBe('sql'));
  it('terraform -> hcl', () => expect(normalizeGitignoreLanguage('terraform')).toBe('hcl'));
  it('opentofu -> hcl', () => expect(normalizeGitignoreLanguage('opentofu')).toBe('hcl'));
  it('tf -> hcl', () => expect(normalizeGitignoreLanguage('tf')).toBe('hcl'));
  it('bash -> shell', () => expect(normalizeGitignoreLanguage('bash')).toBe('shell'));
  it('sh -> shell', () => expect(normalizeGitignoreLanguage('sh')).toBe('shell'));
  it('zsh -> shell', () => expect(normalizeGitignoreLanguage('zsh')).toBe('shell'));
  it('pwsh -> powershell', () => expect(normalizeGitignoreLanguage('pwsh')).toBe('powershell'));
  it('ps1 -> powershell', () => expect(normalizeGitignoreLanguage('ps1')).toBe('powershell'));
});

// ---------------------------------------------------------------------------
// 3. Default-only buckets
// ---------------------------------------------------------------------------

describe('normalizeGitignoreLanguage — default-only values', () => {
  const defaultOnly = ['markdown', 'blank', 'swift', 'yaml', 'json', 'unknown', 'custom'];
  for (const v of defaultOnly) {
    it(`${v} -> undefined`, () => expect(normalizeGitignoreLanguage(v)).toBeUndefined());
  }
});

// ---------------------------------------------------------------------------
// 4. Every LANGUAGE_CATALOG entry maps to a known key
// ---------------------------------------------------------------------------
...
describe('writeGitignoreIfMissing', () => {
  ...
  it('write failure after exclusive create propagates and attempts bounded cleanup', async () => {
    ...
    // Spy on _fsOps.unlink to track that cleanup was attempted.
