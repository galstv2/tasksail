...
import type { AgentConfigModalProps, ExtensionAddForm } from '../../hooks/agent-config/useAgentConfigModal';
...
import MultiSelect, { type MultiSelectOption } from '../shared/MultiSelect';
