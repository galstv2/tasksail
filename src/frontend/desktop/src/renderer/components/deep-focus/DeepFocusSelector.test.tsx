...
describe('DeepFocusSelector', () => {
  ...
  it('collapses plain distributed scalar IDs to the repo scalar before delegation', () => {
    render(
      <DeepFocusSelector
        {...makeProps({
  ...
  it('keeps DeepFocusSelector free of persistence and client boundaries', () => {
    const source = readFileSync(
      join(process.cwd(), 'src/renderer/components/deep-focus/DeepFocusSelector.tsx'),
      'utf8',
    );
