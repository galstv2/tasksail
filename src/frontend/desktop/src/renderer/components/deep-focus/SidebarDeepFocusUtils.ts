...
export function isMonolithEstateType(estateType: string | null | undefined): boolean {
  return isMonolithEstateMode(estateType);
}

export function supportsDeepFocus(estateType: string | null | undefined): boolean {
  return isDistributedEstateMode(estateType) || isMonolithEstateType(estateType);
}
 ...
 * row sits inside a primary's writable area.
 */
...
export function computePopoverActions(
  ...
  // the global buckets feed every primary. With zero primaries
