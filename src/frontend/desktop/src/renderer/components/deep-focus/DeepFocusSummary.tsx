...
function SummaryGlobals({
  ...
  const sectionLabel = globalTest
    ? globalSupports.length > 0
      ? 'Scope for all primaries'
      : 'Test for all primaries'
    : 'Support for all primaries';
  return (
    <section className="deep-focus-summary__globals" aria-label={sectionLabel}>
      <span className="deep-focus-summary__globals-eyebrow">{sectionLabel}</span>
      {globalTest ? (
      ...
      {globalSupports.length > 0 ? (
        <div className="deep-focus-summary__globals-row">
          <span className="deep-focus-summary__globals-label">Support</span>
