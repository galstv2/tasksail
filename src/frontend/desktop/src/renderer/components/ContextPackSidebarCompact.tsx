    ...
    <aside className="panel context-pack-sidebar context-pack-sidebar--collapsed" aria-label="Context pack sidebar">
      <nav className="sidebar-icons" aria-label="Context pack actions">
        ...
        <button type="button" className="sidebar-icon-btn" onClick={() => void onRefreshCatalog()} aria-label="Refresh packs" title="Refresh">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M13.5 8A5.5 5.5 0 1 1 8 2.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><path d="M8 1v3h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </button>
      ...
      <div className="sidebar-collapsed-footer" aria-label="Collapsed context pack controls">
        ...
        <button
          ...
          title="Reseed"
        >
          <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M3 8a5 5 0 0 1 9.5-1.5M13 8a5 5 0 0 1-9.5 1.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/><path d="M12 3v3.5h-3.5M4 13v-3.5h3.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg>
        </button>
        <button
          type="button"
          className="sidebar-collapsed-action"
        ...
        >
          <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M8 1l2 4h4l-3.2 2.8L12 13 8 10.2 4 13l1.2-5.2L2 5h4l2-4z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/></svg>
        </button>
        <button
          type="button"
          className="sidebar-collapsed-action"
