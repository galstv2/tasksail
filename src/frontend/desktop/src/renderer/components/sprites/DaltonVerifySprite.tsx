// Dalton (Verify) — Verification Engineer — Same as Dalton but with white headphones

export function DaltonVerifySprite({ size = 36 }: { size?: number }): JSX.Element {
  const id = 'dalton-verify-pop';
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden="true" focusable="false">
      ...
      {/* Headphone band — white */}
      <path d="M10 28 Q10 10, 32 8 Q54 10, 54 28" fill="none" stroke="#e8e8ee" strokeWidth="2.8" strokeLinecap="round" />
      {/* Ear pads — white */}
      <rect x="5" y="24" width="8" height="12" rx="3" fill="#e8e8ee" />
      <rect x="51" y="24" width="8" height="12" rx="3" fill="#e8e8ee" />
      {/* Pad detail — lighter white */}
      <rect x="7" y="26" width="4" height="8" rx="2" fill="#f4f4f8" />
      <rect x="53" y="26" width="4" height="8" rx="2" fill="#f4f4f8" />
      {/* Pad highlight */}
      <path d="M8 27 L8 31" stroke="#ffffff" strokeWidth="0.6" opacity="0.5" />
      <path d="M56 27 L56 31" stroke="#ffffff" strokeWidth="0.6" opacity="0.5" />
