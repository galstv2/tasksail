// Dalton Verify — Verification Engineer — robot-sprite-grammar-v1 §4.4 — gunmetal+white blocky chassis, verify-green accent, single antenna (male), 5-spike heatsink crown, white headphones with audio jack
    ...
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden="true" focusable="false">
      <defs>
        <linearGradient id={`${id}-face`} x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#88889a" />
        ...
        <radialGradient id={`${id}-tip`} cx="50%" cy="40%" r="60%">
          <stop offset="0%" stopColor="#d8ffd8" />
          <stop offset="60%" stopColor="#40d080" />
          <stop offset="100%" stopColor="#185838" />
        </radialGradient>
      ...
      {/* §4.4 5-spike heatsink fin array */}
      <g>
      ...
      {/* §2.4 Single central antenna (male), verify-green tip */}
      <g>
        <circle cx="32" cy="2.5" r="2.0" fill={`url(#${id}-tip)`} stroke="#185838" strokeWidth="0.4" />
        <circle cx="31.4" cy="1.9" r="0.55" fill="#f0fff0" opacity="0.95" />
      ...
      {/* §4.4 White verification plates */}
      <g>
        <rect x="13" y="17" width="14" height="6" rx="1" fill="#f4f4f8" stroke="#0e0e16" strokeWidth="0.3" opacity="0.92" />
        <rect x="37" y="45" width="14" height="6" rx="1" fill="#f4f4f8" stroke="#0e0e16" strokeWidth="0.3" opacity="0.92" />
        <line x1="14" y1="20" x2="26" y2="20" stroke="#40d080" strokeWidth="0.4" opacity="0.7" />
        <line x1="38" y1="48" x2="50" y2="48" stroke="#40d080" strokeWidth="0.4" opacity="0.7" />
      </g>
      ...
      {/* §4.4 White headphones + green pod LEDs + audio jack cord */}
      <g>
        <path d="M10 28 Q10 14, 32 12 Q54 14, 54 28" fill="none" stroke="#e0e0e6" strokeWidth="2.6" strokeLinecap="round" />
        <path d="M10 28 Q10 14, 32 12 Q54 14, 54 28" fill="none" stroke="#9a9aa6" strokeWidth="0.4" strokeLinecap="round" opacity="0.55" />
        <rect x="4.5" y="24" width="9" height="13" rx="2" fill={`url(#${id}-cup)`} stroke="#5a5a68" strokeWidth="0.4" />
        <rect x="6.5" y="26" width="5" height="9" rx="1.5" fill="#dadae2" />
        <circle cx="9" cy="30.5" r="0.4" fill="#40d080" opacity="0.9" />
        <line x1="6.5" y1="30.5" x2="11.5" y2="30.5" stroke="#9a9aa6" strokeWidth="0.3" opacity="0.55" />
        <path d="M5 35 Q3 40, 5 46" fill="none" stroke="#5a5a68" strokeWidth="0.7" strokeLinecap="round" />
        <rect x="3.6" y="46" width="2.8" height="3.2" rx="0.4" fill="#e0e0e6" stroke="#5a5a68" strokeWidth="0.3" />
        <line x1="4" y1="47" x2="6" y2="47" stroke="#9a9aa6" strokeWidth="0.3" />
        <line x1="4" y1="48" x2="6" y2="48" stroke="#9a9aa6" strokeWidth="0.3" />
        <rect x="50.5" y="24" width="9" height="13" rx="2" fill={`url(#${id}-cup)`} stroke="#5a5a68" strokeWidth="0.4" />
        <rect x="52.5" y="26" width="5" height="9" rx="1.5" fill="#dadae2" />
        <circle cx="55" cy="30.5" r="0.4" fill="#40d080" opacity="0.9" />
        <line x1="52.5" y1="30.5" x2="57.5" y2="30.5" stroke="#9a9aa6" strokeWidth="0.3" opacity="0.55" />
      </g>

      {/* §2.3 Eye optics — verify-green pupils */}
      <EyeOptics
        size={size}
        socketFill="#0e0e16"
        bezelStroke="#7a7a8a"
      ...
      <g>
        <circle cx="29" cy="40.6" r="0.32" fill="#40d080" opacity="0.9" />
        <circle cx="32" cy="40.6" r="0.32" fill="#40d080" opacity="0.9" />
        <circle cx="35" cy="40.6" r="0.32" fill="#40d080" opacity="0.9" />
