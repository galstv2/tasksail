...
class PackWriter:
    ...
    def _derive_focus_area_types(self, model: RepoSourcesManifestV2) -> None:
        ...
        # Synthesis: recover primary_focus_area_ids from legacy repository_type field
    ...
    def _load_as_v2(self) -> RepoSourcesManifestV2:
        ...
        # Auto-heal: upgrade v1 → v2 in-memory so update_manifest always works on v2
    ...
    def write_manifest(self, manifest: RepoSourcesManifestV2) -> None:
        ...
        # Validate the dumped shape to catch drift between in-memory and disk representation
