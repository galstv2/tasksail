...
export class PlatformError extends Error {
  ...
  constructor(message: string, opts: PlatformErrorOptions) {
    ...
    this.name = new.target?.name ?? 'PlatformError';
    this.code = opts.code;
...
export class MCPError extends PlatformError {}
export class AgentRunError extends PlatformError {}
export class QueueError extends PlatformError {}
export class ContextPackError extends PlatformError {}
