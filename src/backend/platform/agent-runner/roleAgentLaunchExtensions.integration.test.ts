...
vi.mock('./metadata.js', () => ({ loadAgentRegistry: mocks.loadAgentRegistry, resolveAgentProfile: mocks.resolveAgentProfile, resolveActiveModel: mocks.resolveActiveModel, toRegistryId: (_provider: unknown, id: string) => ({ lily: 'planning-agent', alice: 'product-manager', dalton: 'software-engineer', 'dalton-verify': 'software-engineer-verify', ron: 'qa' } as Record<string, string>)[id] }));
