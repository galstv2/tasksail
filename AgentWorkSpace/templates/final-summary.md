...
<!-- (1-5 bullets) — major choices and their rationale -->

## Known Limitations
<!-- (1-5 bullets) — what was not addressed; "None" if complete -->
...
## Follow-Up Backlog
<!-- (1-5 bullets) — future work items; "None" if not applicable -->

## Difficulty Assessment
<!-- (1 word, title-case) — write inline: "- Difficulty Level: Easy" (or Medium, or Hard). The format must match exactly; values on a separate line or as prose fail validation. -->
- Difficulty Level:
